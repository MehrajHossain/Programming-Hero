...
// task 2
var templateString = `
  Brand name: ${myObj.brand}
  Brand Value: ${myObj.brandValue}
  Sub-brand Name: ${myObj.subBrand.brand2}
`
console.log(templateString);

//task 3
const arrowFunc = para1 => console.log(89);
arrowFunc();

//task 4
const numbers = [7, 14, 28, 77];
const newArr = numbers.map(num => num / 7)
console.log(newArr);
